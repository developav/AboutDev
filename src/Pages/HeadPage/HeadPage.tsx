          ...
          <div className="container">
            <div className="head__block">
              ...
              <div className="head__block-cv">
                <a href="/AboutDev/docx/Dmitrii_Pavlov_CV_Updated.docx" className="head__block-cv-download" download="Dmitrii_Pavlov_CV_Updated.docx" aria-label="Download my CV">
                  Download CV
