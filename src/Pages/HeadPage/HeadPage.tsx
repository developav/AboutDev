            ...
            <div className="container">
                <div className="head__block">
                    ...
                    <div className="head__block-men">
                        <img src="../../../public/head.png" alt="" className="head__block-men-img"/>
                    </div>
                    <div className="head__block-cv">
                        <a href="docs/Интерактивная трибуна 21,5.PDF" className="head__block-cv-download" download="Интерактивная трибуна 21,5.PDF">Скачать CV<svg className="head__block-cv-svg"><use xlink:href="#ArrowLineDown"></use></svg></a>
                        <a href="#" className="head__block-cv-contact"><svg className="head__block-cv-svg"><use xlink:href="#WhatsappLogo"></use></svg>Связаться со мной</a>
                    </div>
                </div>
            </div>
        </section>
